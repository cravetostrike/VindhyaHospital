<?php
/**
 * VHRC Admin Sidebar Navigation Layout
 */
...
<aside class="admin-sidebar">
    <div class="sidebar-header">
        <a href="index.php" class="sidebar-brand">
            <img src="../images/logo.png" alt="VHRC Logo" class="sidebar-logo">
            <h1>VHRC Admin</h1>
        </a>
    </div>
    ...
    <nav class="sidebar-menu">
        <!-- 1. Dashboard -->
        <a href="index.php" class="menu-item <?php echo ($active_page === 'index.php') ? 'active' : ''; ?>">
        ...
        <a href="manage-appointments.php" class="menu-item <?php echo ($active_page === 'manage-appointments.php') ? 'active' : ''; ?>">
        ...
        <!-- 3. Manage Doctors -->
        <a href="manage-doctors.php" class="menu-item <?php echo ($active_page === 'manage-doctors.php') ? 'active' : ''; ?>">
        ...
        <!-- 4. Manage Graphics Gallery -->
        <a href="manage-gallery.php" class="menu-item <?php echo ($active_page === 'manage-gallery.php') ? 'active' : ''; ?>">
            ...
            <span>Homepage Posters</span>
        </a>

        <!-- 5. Homepage CMS Settings -->
        <a href="manage-homepage.php" class="menu-item <?php echo ($active_page === 'manage-homepage.php') ? 'active' : ''; ?>">
        ...
        <!-- 6. Site Settings -->
        <a href="settings.php" class="menu-item <?php echo ($active_page === 'settings.php') ? 'active' : ''; ?>">
    ...
    <div class="sidebar-footer">
        <a href="logout.php" class="logout-btn confirm-action" data-confirm-message="Are you sure you want to log out of the admin panel?">
