...
<head>
    ...
    <title>Dr. Abhishek Mishra - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Abhishek Mishra at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Abhishek Mishra's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-abhishek-mishra.jpg'; ?>" alt="Dr. Abhishek Mishra" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">BDS, MDS, MRCS - DENTAL / ORAL &amp; MAXILLOFACIAL SURGERY</span>
                <h1 class="hero-doctor-name">Dr. Abhishek Mishra</h1>
                <p class="hero-subtitle">Oral &amp; Maxillofacial Surgeon</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">BDS</span>
                    <span class="degree-pill">MDS</span>
                    <span class="degree-pill">MRCS</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Abhishek Mishra is a highly skilled and experienced Oral &amp; Maxillofacial Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 12 years of practice. He specializes in comprehensive surgical care for dental, oral, and facial conditions, providing advanced treatments with precision and patient-focused care.</p>
                        <p>The Dental, Oral &amp; Maxillofacial Surgery Department at Vindhya Hospital is well-equipped to handle a wide spectrum of procedures, from routine dental surgeries to complex maxillofacial reconstructions, ensuring safe and effective outcomes for patients.</p>
                    </div>

                    <!-- Tab 2: Education (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-education">
                        <p><strong>BDS:</strong> [University Name, Year]</p>
                        <p><strong>MDS:</strong> [University Name, Year]</p>
                        <p><strong>MRCS:</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Oral &amp; Maxillofacial Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 12+ years of dedicated clinical experience in Oral &amp; Maxillofacial Surgery, recognized as one of the best Oral &amp; Maxillofacial Surgeons in Rewa for delivering safe, precise, and effective patient outcomes.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Oral and maxillofacial surgeries</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Dental implants and corrective jaw surgery</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Treatment of facial trauma and fractures</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Management of congenital facial deformities</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>TMJ disorders and dental reconstructive procedures</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pediatric oral &amp; maxillofacial surgery</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Dental</span>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ORAL &amp; MAXILLOFACIAL SURGERY</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>COMPLEX DENTAL &amp; FACIAL PROCEDURES</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT-CENTERED DENTAL CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
