...
<head>
    ...
    <title>Dr. Annapurna Singh Bhadauriya - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Annapurna Singh Bhadauriya at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Annapurna Singh Bhadauriya's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-annapurna-singh-bhadauriya.jpg'; ?>" alt="Dr. Annapurna Singh Bhadauriya" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, D.C.H - PAEDIATRICIAN</span>
                <h1 class="hero-doctor-name">Dr. Annapurna Singh Bhadauriya</h1>
                <p class="hero-subtitle">Paediatrician</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">D.C.H</span>
                    <span class="degree-pill">PGPN</span>
                    <span class="degree-pill">IGPN</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Annapurna Singh Bhadauriya is an experienced and dedicated Paediatrician at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), providing specialized care for infants, children, and adolescents. With strong academic qualifications and clinical expertise, she focuses on delivering holistic pediatric care, ensuring the healthy growth and development of children.</p>
                        <p>She offers medical care for common childhood illnesses, developmental disorders, vaccinations, nutritional guidance, and chronic pediatric conditions, with a compassionate and family-friendly approach.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>Specialized Certifications:</strong> Postgraduate training in pediatric nutrition and growth (PGPN, IGPN).</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Paediatrician at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Extensively trained in tracking developmental updates, formulating pediatric nutritional blueprints, managing childhood acute/chronic complications, and guiding immunizations. Known for providing personalized, child-friendly care models.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Comprehensive pediatric care (newborn to adolescent)</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Growth and developmental monitoring</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Child nutrition &amp; preventive healthcare</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Vaccination &amp; immunization programs</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Management of acute &amp; chronic pediatric illnesses</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Parental counseling for child health and development</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CHILD HEALTH &amp; DEVELOPMENT CARE</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PED_ILLNESS &amp; CHRONIC CONDITION MANAGEMENT</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>VACCINATION &amp; PREVENTIVE PEDIATRICS</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>NUTRITIONAL &amp; GROWTH COUNSELING</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Morning – 12:00 PM to 02:00 PM</p>
                            </div>
                        </div>
