...
<head>
    ...
    <title>Dr. Anusha Pandey - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Anusha Pandey at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Anusha Pandey's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-anusha-pandey.jpg'; ?>" alt="Dr. Anusha Pandey" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                ...
                <h1 class="hero-doctor-name">Dr. Anusha Pandey</h1>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Anusha Pandey is a highly skilled and compassionate Obstetrician &amp; Gynecologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of private practice in women's healthcare.</p>
                        <p>She is recognized for her expertise in managing high-risk pregnancies, infertility, menopause, and advanced gynecological care, offering complete medical support for women across all age groups. Her practice covers the full spectrum of obstetrics and gynecology—from routine antenatal checkups, safe deliveries, and postnatal care, to the treatment of menstrual disorders, contraceptive management, infertility evaluation, and minimally invasive gynecological surgeries.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><em>*Education details are currently being updated.</em></p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        ...
                        <p>Over 10+ years of dedicated clinical experience in Obstetrics &amp; Gynecology, specializing in high-risk pregnancy management and comprehensive women's healthcare solutions.</p>
                    </div>
                </div>

                <!-- Specializations Block -->
                <div class="profile-card-block">
                    <h2 class="section-title-accent green-line">Specializations &amp; Expertise</h2>
                    <div class="expertise-grid">
                            ...
                            <span>High-risk pregnancy care &amp; delivery management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Infertility diagnosis and treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Menopause care &amp; hormonal disorder management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Laparoscopic &amp; minimally invasive gynecological surgeries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Contraception &amp; family planning counseling</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Preventive women’s health and wellness programs</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>INFERTILITY EVALUATION &amp; TREATMENT</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ADVANCED GYNECOLOGICAL CARE</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MENSTRUAL DISORDER MANAGEMENT</h5>
                                <span>92%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CONTRACEPTIVE &amp; FAMILY PLANNING COUNSELING</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 95%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT CARE &amp; EMOTIONAL SUPPORT</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Morning – 10:00 AM to 02:00 PM</p>
                            </div>
                        </div>
