...
<head>
    ...
    <title>Dr. Aradhana Tripathi - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Aradhana Tripathi at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Aradhana Tripathi's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-aradhana-tripathi.jpg'; ?>" alt="Dr. Aradhana Tripathi" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS (GOLD MEDALIST), MD - CANCER SPECIALIST</span>
                <h1 class="hero-doctor-name">Dr. Aradhana Tripathi</h1>
                <p class="hero-subtitle">Radiation &amp; Clinical Oncologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS (Gold Medalist)</span>
                    <span class="degree-pill">MD (Cancer Specialist)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Aradhana Tripathi is a highly accomplished Radiation &amp; Clinical Oncologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.). With over a decade of private practice, she specializes in the prevention, diagnosis, and treatment of cancer, offering personalized care to patients with compassion and expertise.</p>
                        <p>She is skilled in managing a wide spectrum of cancers using advanced techniques like chemotherapy, radiation therapy, and clinical oncology approaches, ensuring comprehensive cancer care under one roof.</p>
                    </div>

                    <!-- Tab 2: Education (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-education">
                        <p><strong>MBBS:</strong> [University Name, Year] (Gold Medalist)</p>
                        <p><strong>MD (Cancer Specialist):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Radiation &amp; Clinical Oncologist at Vindhya Hospital &amp; Research Centre, Rewa.</p>
                        <p>10 Years of private practice in Oncology, delivering comprehensive cancer treatment, holistic management, and post-treatment recovery support.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Radiation &amp; Clinical Oncology</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Chemotherapy &amp; targeted therapy</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Cancer prevention, diagnosis &amp; staging</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Holistic cancer management &amp; counseling</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Post-treatment rehabilitation support</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CANCER DIAGNOSIS &amp; TREATMENT</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>RADIATION &amp; CHEMOTHERAPY TECHNIQUES</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT-CENTERED ONCOLOGY CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CLINICAL RESEARCH &amp; PREVENTIVE ONCOLOGY</h5>
                                <span>92%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Evening – 04:00 PM to 06:00 PM</p>
                            </div>
                        </div>
