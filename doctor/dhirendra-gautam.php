...
<head>
    ...
    <title>Dr. Dhirendra Gautam - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Dhirendra Gautam at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Dhirendra Gautam's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-dhirendra-gautam.jpg'; ?>" alt="Dr. Dhirendra Gautam" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, DNB (MEDICINE) - GENERAL PHYSICIAN</span>
                <h1 class="hero-doctor-name">Dr. Dhirendra Gautam</h1>
                <p class="hero-subtitle">General Medicine Specialist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">DNB (Medicine)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    <div class="tab-nav-header">
                        ...
                        <button class="tab-btn" data-tab="tab-awards">Awards &amp; Honours</button>
                    </div>

                    <!-- Tab 1: About (Active by default) -->
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Dhirendra Gautam is a highly skilled and experienced General Medicine Specialist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with more than 10 years of medical practice. He is known for his expertise in diagnosing and managing both acute and chronic health conditions in adults.</p>
                        <p>His patient-centric approach and evidence-based treatments make him one of the most trusted General Medicine Consultants in Rewa and nearby regions, recognized widely for delivering compassionate and comprehensive medical care.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>DNB (Medicine):</strong> [University Name, Year]</p>
                        <p><em>*Education timelines and specific university details are currently being updated.</em></p>
                    </div>

                    <!-- Tab 3: Awards & Honours (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-awards">
                        <ul>
                            <li><strong>1988:</strong> British Thoracic Society Fisons Travel Fellowship</li>
                            <li><strong>1991:</strong> British Medical Association HC Roscoe Fellowship</li>
                            <li><strong>1997:</strong> Royal College of Physicians Graham Bull Prize in Clinical Science</li>
                            <li><strong>2004:</strong> North American CF Conference Plenary Lecturer (first non-American)</li>
                            <li><strong>2005:</strong> CF Trust John Panchaud Medal</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>General Medicine disease treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Diagnosis &amp; management of acute and chronic illnesses</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Lifestyle disorder management (Hypertension, Diabetes, Thyroid Disorders)</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Infectious disease treatment and preventive care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Geriatric medicine and family healthcare</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Health counseling &amp; long-term wellness management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>COMPASSIONATE PATIENT-CENTRIC CARE</h5>
                                <span>99%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT COUNSELING &amp; EDUCATION</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>GENERAL MEDICINE &amp; ADULT HEALTHCARE</h5>
                                <span>97%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>DIAGNOSIS &amp; MANAGEMENT OF CHRONIC DISEASES</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>EVIDENCE-BASED CLINICAL PRACTICE</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 96%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PREVENTIVE HEALTH &amp; WELLNESS CARE</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MANAGEMENT OF ACUTE ILLNESSES</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>DIABETES &amp; HYPERTENSION MANAGEMENT</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>INFECTIOUS DISEASE TREATMENT</h5>
                                <span>92%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>EMERGENCY &amp; CRITICAL CARE MANAGEMENT</h5>
                                <span>91%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Contact Hospital Desk</p>
                            </div>
                        </div>
