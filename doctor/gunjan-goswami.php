...
<head>
    ...
    <title>Dr. Gunjan Goswami - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Gunjan Goswami at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Gunjan Goswami's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-gunjan-goswami.jpg'; ?>" alt="Dr. Gunjan Goswami" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MS (OBSTETRICS &amp; GYNECOLOGY)</span>
                <h1 class="hero-doctor-name">Dr. Gunjan Goswami</h1>
                <p class="hero-subtitle">Obstetrician &amp; Gynecologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MS (Obstetrics &amp; Gynecology)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Gunjan Goswami is an experienced and dedicated Obstetrician &amp; Gynecologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with more than 10 years of private practice. She specializes in high-risk pregnancy care, infertility management, menopause care, and advanced gynecological treatments, offering holistic medical support to women at every stage of life.</p>
                        <p>Her department provides complete obstetric and gynecological care, including antenatal checkups, safe delivery services, family welfare, infertility solutions, and menopause management. She also treats complex gynecological conditions with advanced techniques, including contraceptive management, laparoscopic procedures, and hormonal disorder treatment.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MS (Obstetrics &amp; Gynecology):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Obstetrician &amp; Gynecologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of dedicated private practice in women’s healthcare, specializing heavily in high-risk pregnancy management, complete maternal clinical evaluations, and advanced laparoscopic surgical solutions.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>High-risk pregnancy care &amp; deliveries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Infertility evaluation and treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Menstrual &amp; hormonal disorder management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Menopause &amp; post-menopausal care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Contraceptive management &amp; family planning</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Laparoscopic and minimally invasive gynecological surgeries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Preventive women’s healthcare programs</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>HIGH-RISK PREGNANCY CARE</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ANTENATAL &amp; POSTNATAL CARE</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ADVANCED GYNECOLOGICAL TREATMENTS</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MENOPAUSE &amp; HORMONAL DISORDER MANAGEMENT</h5>
                                <span>92%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>LAPAROSCOPIC &amp; MINIMALLY INVASIVE SURGERY</h5>
                                <span>90%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CONTRACEPTIVE &amp; FAMILY WELFARE COUNSELING</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 95%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MANAGEMENT OF COMPLEX GYNECOLOGICAL CONDITIONS</h5>
                                <span>91%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT COUNSELING &amp; HOLISTIC CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>WOMEN’S HEALTH &amp; WELLNESS SUPPORT</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Evening – 02:00 PM to 04:00 PM</p>
                            </div>
                        </div>
