...
<head>
    ...
    <title>Dr. Jitesh Gawande - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Jitesh Gawande at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Jitesh Gawande's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-jitesh-gawande.jpg'; ?>" alt="Dr. Jitesh Gawande" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MS (ORTHOPEDICS) - ADVANCED TRAUMA CENTRE</span>
                <h1 class="hero-doctor-name">Dr. Jitesh Gawande</h1>
                <p class="hero-subtitle">Orthopedic Surgeon</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MS (Orthopedics)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Jitesh Gawande is a highly skilled and experienced Orthopedic Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of private practice. He specializes in orthopedic surgeries, trauma management, and advanced musculoskeletal care, providing comprehensive treatment for patients with bone, joint, and trauma-related conditions.</p>
                        <p>The Orthopedics &amp; Advanced Trauma Centre at Vindhya Hospital is equipped with state-of-the-art facilities, ensuring efficient management of complex trauma cases and orthopedic disorders. Dr. Gawande is known for his precision, advanced surgical techniques, and patient-focused care.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><em>*Education timelines are currently being updated.</em></p>
                    </div>

                    <!-- Tab 3: Experience (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Orthopedic Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of active clinical practice in Orthopedics &amp; Advanced Trauma Care. Recognized as one of the best Orthopedic &amp; Trauma Specialists in Rewa, combining accurate pre-operative evaluations with expert fracture restorations and customized post-trauma structural recovery programs.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Bone and joint trauma management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Advanced orthopedic surgeries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Fracture care and post-trauma rehabilitation</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Sports injury treatment</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Spine and musculoskeletal disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ORTHOPEDIC SURGERY &amp; TRAUMA MANAGEMENT</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MUSCULOSKELETAL DISORDER TREATMENT</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT-CENTERED ORTHOPEDIC CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
