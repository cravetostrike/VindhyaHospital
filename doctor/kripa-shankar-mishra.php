...
<head>
    ...
    <title>Dr. Kripa Shankar Mishra - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Kripa Shankar Mishra at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Kripa Shankar Mishra's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-kripa-shankar-mishra.jpg'; ?>" alt="Dr. Kripa Shankar Mishra" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, D. ORTHO - ORTHOPEDIC SPECIALIST</span>
                <h1 class="hero-doctor-name">Dr. Kripa Shankar Mishra</h1>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Kripa Shankar Mishra is a highly experienced and compassionate Orthopedic Specialist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with more than 10 years of clinical practice. He is proficient in handling a wide spectrum of orthopedic problems, ranging from routine bone and joint issues to complex fractures and trauma cases.</p>
                        <p>With his vast experience and patient-friendly approach, Dr. Mishra ensures effective treatments and personalized care that help patients restore mobility, manage pain, and lead healthier lives.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Orthopedic Specialist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of dedicated practice in Orthopedics, recognized as one of the best Orthopedic Consultants in Rewa for bone structural diagnostics, personalized trauma care, and effective skeletal pain therapies.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Trauma &amp; fracture management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Arthritis and joint pain treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Bone health &amp; osteoporosis care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Sports injury management</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Back, neck &amp; spine disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>BONE &amp; JOINT DISORDER MANAGEMENT</h5>
                                <span>96%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>FRACTURE &amp; TRAUMA TREATMENT</h5>
                                <span>97%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ORTHOPEDIC REHABILITATION &amp; PAIN MANAGEMENT</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
