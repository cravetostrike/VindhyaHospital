...
<head>
    ...
    <title>Dr. Mukund Pandey - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Mukund Pandey at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Mukund Pandey's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-mukund-pandey.jpg'; ?>" alt="Dr. Mukund Pandey" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MS (GENERAL SURGERY)</span>
                <h1 class="hero-doctor-name">Dr. Mukund Pandey</h1>
                <p class="hero-subtitle">General &amp; Laparoscopic Surgeon</p>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Mukund Pandey is a highly skilled and experienced General &amp; Laparoscopic Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of practice. He specializes in both open and minimally invasive surgeries, providing expert care for a wide range of surgical conditions.</p>
                        <p>He is recognized for performing advanced laparoscopic procedures, emergency surgeries, and routine general surgeries, ensuring patient safety, faster recovery, and optimal outcomes.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant General &amp; Laparoscopic Surgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of dedicated surgical practice. Highly regarded as one of the best General &amp; Laparoscopic Surgeons in Rewa for executing precise routine operations, complex open interventions, and prompt emergency trauma stabilization.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Laparoscopic surgery (gallbladder, appendix, hernia, etc.)</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>General surgery procedures</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Management of acute and chronic abdominal conditions</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Emergency and trauma surgery</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Post-operative care and rehabilitation</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Treatment of complex gastrointestinal disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>GENERAL SURGERY (OPEN &amp; ROUTINE PROCEDURES)</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>EMERGENCY &amp; CRITICAL SURGICAL CARE</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT SAFETY &amp; POST-OPERATIVE RECOVERY</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value font-small">
                                    Afternoon – 02:00 PM to 06:00 PM<br>
                                    Rest Time: On Call
                                </p>
                            </div>
                        </div>
