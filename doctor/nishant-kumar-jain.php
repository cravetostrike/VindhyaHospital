...
<head>
    ...
    <title>Dr. Nishant Kumar Jain - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Nishant Kumar Jain at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Nishant Kumar Jain's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-nishant-kumar-jain.jpg'; ?>" alt="Dr. Nishant Kumar Jain" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, DNB (MEDICINE), MNAMS, DNB (GASTROENTEROLOGY)</span>
                <h1 class="hero-doctor-name">Dr. Nishant Kumar Jain</h1>
                <p class="hero-subtitle">Gastroenterologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">DNB (Medicine)</span>
                    <span class="degree-pill">MNAMS</span>
                    <span class="degree-pill">DNB (Gastroenterology)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Nishant Kumar Jain is a highly experienced and skilled Gastroenterologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of clinical practice. He specializes in the diagnosis, treatment, and management of disorders affecting the digestive system, including the esophagus, stomach, intestines, pancreas, liver, gallbladder, and bile ducts.</p>
                        <p>He provides comprehensive care for both common and complex gastrointestinal conditions, ranging from acid reflux, ulcers, and hepatitis to inflammatory bowel disease and liver cancer, ensuring precise diagnosis and personalized treatment plans.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MNAMS:</strong> [University Name, Year]</p>
                        <p><strong>DNB (Gastroenterology):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Gastroenterologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of dedicated clinical practice in Gastroenterology, recognized as one of the best medical practitioners in digestive and liver care within the Rewa region.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Gastrointestinal disorders (acid reflux, ulcers, IBS)</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Liver diseases, hepatitis, and cirrhosis management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pancreatic and biliary tract disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Endoscopic procedures and colonoscopy</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Diagnosis and management of inflammatory bowel disease</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Nutritional counseling for digestive health</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>GASTROINTESTINAL DISEASE DIAGNOSIS &amp; MANAGEMENT</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>LIVER &amp; PANCREATIC DISORDERS</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ENDOSCOPIC &amp; MINIMALLY INVASIVE PROCEDURES</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT-CENTERED GASTROENTEROLOGY CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Morning – 10:00 AM to 06:00 PM</p>
                            </div>
                        </div>
