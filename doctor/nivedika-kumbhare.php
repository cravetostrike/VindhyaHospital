...
<head>
    ...
    <title>Dr. Nivedika Kumbhare - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Nivedika Kumbhare at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Nivedita Kushre's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-nivedita-kushre.jpg'; ?>" alt="Dr. Nivedita Kushre" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">M.D. (ANESTHESIOLOGY) - ANESTHESIA &amp; CRITICAL CARE SPECIALIST</span>
                <h1 class="hero-doctor-name">Dr. Nivedika Kumbhare</h1>
                <p class="hero-subtitle">Anesthesia &amp; Critical Care Specialist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">M.D. (Anesthesiology)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    <div class="tab-nav-header">
                        ...
                        <button class="tab-btn" data-tab="tab-services">Services Offered</button>
                    </div>

                    <!-- Tab 1: About (Active by default) -->
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Nivedika Kumbhare is a skilled Anesthesia specialist associated with Vindhya Hospital &amp; Research Center, Rewa (M.P.). She specializes in providing safe and effective anesthesia care for surgical procedures, emergency care, and critical patient monitoring with a strong focus on patient safety and comfort.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>M.D. (Anesthesiology):</strong> [University Name, Year]</p>
                        <p><em>*Education details and graduation timelines are currently being updated.</em></p>
                    </div>

                    <!-- Tab 3: Services Offered (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-services">
                        <p>Dr. Nivedika Kumbhare maps precise operations across high-criticality healthcare avenues:</p>
                        <ul>
                            <li>Anesthesia for Major &amp; Minor Surgeries</li>
                            <li>ICU &amp; Critical Care Support</li>
                            <li>Emergency Anesthesia Care</li>
                            <li>Pain Relief &amp; Management</li>
                            <li>Surgical Patient Monitoring</li>
                            <li>Trauma &amp; Critical Patient Assistance</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>General &amp; Regional Anesthesia</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Critical Care &amp; ICU Support</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Emergency &amp; Trauma Anesthesia</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Preoperative &amp; Postoperative Care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pain Management Services</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Airway &amp; Ventilator Management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Surgical Patient Monitoring</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Anesthesia for Major &amp; Minor Surgeries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Intensive Care Patient Management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Patient Safety &amp; Perioperative Care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Anesthesia &amp; Critical Care</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PREOPERATIVE PATIENT ASSESSMENT</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>EMERGENCY &amp; TRAUMA ANESTHESIA</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 94%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>POSTOPERATIVE CARE MANAGEMENT</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 93%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT SAFETY &amp; SURGICAL SUPPORT</h5>
                                <span>97%</span>
                            </div>
                            <div class="progress-bar-track">
