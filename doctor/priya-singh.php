...
<head>
    ...
    <title>Dr. Priya Singh - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Priya Singh at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Priya Singh's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-priya-singh.jpg'; ?>" alt="Dr. Priya Singh" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MD (PATHOLOGY)</span>
                <h1 class="hero-doctor-name">Dr. Priya Singh</h1>
                <p class="hero-subtitle">Pathologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MD (Pathology)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Priya Singh is a highly experienced and skilled Pathologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of practice. She is an expert in diagnostic pathology and oversees accurate testing and reporting in the hospital’s NABH-accredited clinical laboratory, which is equipped with advanced technology for modern diagnostics.</p>
                        <p>She ensures precise and timely results for a wide range of laboratory tests, supporting physicians in diagnosis, treatment planning, and patient care.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MD (Pathology):</strong> [University Name, Year]</p>
                        <p><em>*Education timelines and details are currently being updated.</em></p>
                    </div>

                    <!-- Tab 3: Experience (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Pathologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of clinical laboratory practice in Pathology, ensuring absolute adherence to NABH quality guidelines, laboratory control workflows, and advanced modern diagnostics. Highly recognized as one of the best pathologists in Rewa.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Clinical and diagnostic pathology</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Blood tests, biochemistry, and hematology</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Histopathology and cytology</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Laboratory quality control and NABH standards compliance</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Support for disease diagnosis and management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>(Pathology)</span>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>DIAGNOSTIC PATHOLOGY &amp; LAB ANALYSIS</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CLINICAL LABORATORY MANAGEMENT</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ACCURATE &amp; TIMELY TEST REPORTING</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>SUPPORTING PHYSICIANS IN DIAGNOSIS &amp; TREATMENT</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value font-small">
                                    Morning – 09:00 AM to 01:00 PM<br>
                                    Evening – 01:00 PM to 04:00 PM
                                </p>
                            </div>
                        </div>
