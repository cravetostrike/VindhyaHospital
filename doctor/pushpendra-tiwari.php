...
<head>
    ...
    <title>Dr. Pushpendra Tiwari - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Pushpendra Tiwari at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Pushpendra Tiwari's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-pushpendra-tiwari.jpg'; ?>" alt="Dr. Pushpendra Tiwari" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">D.ORTHO - ORTHOPEDIC SPECIALIST</span>
                <h1 class="hero-doctor-name">Dr. Pushpendra Tiwari</h1>
                <p class="hero-subtitle">Orthopedic Specialist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">D.Ortho</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Pushpendra Tiwari is a dedicated and highly skilled Orthopedic Specialist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 10 years of clinical experience. He is proficient in diagnosing, treating, and managing a wide range of orthopedic conditions, from common bone and joint problems to complex musculoskeletal disorders.</p>
                        <p>He is well-regarded for his patient-focused approach and effective treatment plans, helping patients regain mobility and improve their quality of life by delivering advanced and compassionate care.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>D.Ortho (Diploma in Orthopedics):</strong> [University Name, Year]</p>
                        <p><em>*Education timelines and institutional graduation details are currently being updated.</em></p>
                    </div>

                    <!-- Tab 3: Experience (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current Position:</strong> Consultant Orthopedic Specialist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 10+ years of dedicated operational practice in Orthopedics, trauma response coordination, bone diagnostics, and custom physical musculoskeletal adjustment programs.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Bone and joint disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Back and spine pain management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Arthritis and osteoporosis care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Trauma and fracture management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Sports injuries treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Post-operative rehabilitation support</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>FRACTURE &amp; TRAUMA MANAGEMENT</h5>
                                <span>96%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>JOINT &amp; BONE DISORDER TREATMENT</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MUSCULOSKELETAL REHABILITATION</h5>
                                <span>92%</span>
                            </div>
                            <div class="progress-bar-track">
