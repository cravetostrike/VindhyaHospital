...
<head>
    ...
    <title>Dr. Ritu Singh - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Ritu Singh at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Ritu Singh's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-ritu-singh.jpg'; ?>" alt="Dr. Ritu Singh" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MD (ANAESTHESIA)</span>
                <h1 class="hero-doctor-name">Dr. Ritu Singh</h1>
                <p class="hero-subtitle">Anaesthesiologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MD (Anaesthesia)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Ritu Singh is a highly skilled and experienced Anaesthesiologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.). She specializes in providing safe and effective anesthesia care for a wide range of surgical procedures, ensuring patient comfort, safety, and optimal outcomes.</p>
                        <p>Her expertise includes general and regional anesthesia, post-operative pain management, and critical care support, offering comprehensive perioperative care to patients of all age groups with a deeply patient-centric approach.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MD (Anaesthesia):</strong> MP Medical Science University, Jabalpur</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Anaesthesiologist at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Extensive clinical proficiency managing critical care situations, administering advanced regional or general anesthesia combinations, and coordinating complex perioperative recovery pathways.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>General anesthesia for surgical procedures</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Regional anesthesia (spinal, epidural, nerve blocks)</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Post-operative pain management</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>ICU and critical care support</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pre-operative evaluation and patient counseling</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>GENERAL &amp; REGIONAL ANESTHESIA</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PERIOPERATIVE PATIENT CARE</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>POST-OPERATIVE PAIN MANAGEMENT</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CRITICAL CARE &amp; EMERGENCY SUPPORT</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value font-small">Morning – 08:00 AM to 08:00 PM</p>
                            </div>
                        </div>
