...
<head>
    ...
    <title>Dr. Sahiba Singh - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Sahiba Singh at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Sahiba Singh's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-sahiba-singh.jpg'; ?>" alt="Dr. Sahiba Singh" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS (D.G.O) - OBSTETRICS &amp; GYNECOLOGY SPECIALIST</span>
                <h1 class="hero-doctor-name">Dr. Sahiba Singh</h1>
                <p class="hero-subtitle">Obstetrics &amp; Gynecology Specialist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">D.G.O</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Sahiba Singh is a dedicated Obstetrics &amp; Gynecology specialist associated with Vindhya Hospital &amp; Research Center, Rewa (M.P.). She provides comprehensive women’s healthcare services with a compassionate and patient-centered approach, ensuring safe and effective treatment for every stage of womanhood.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>D.G.O (Diploma in Gynecology and Obstetrics):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-services">
                        <p>Dr. Sahiba Singh offers dynamic and high-quality clinical operations across specific women's health domains, including:</p>
                        <ul>
                            <li>Pregnancy Monitoring &amp; Consultation</li>
                            <li>Family Planning &amp; Counseling</li>
                            <li>Menopause Care</li>
                            <li>Adolescent Gynecology Care</li>
                            <li>Routine Women’s Health Screening</li>
                            <li>Personalized Maternal Care</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>High-Risk Pregnancy Care</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Normal &amp; Cesarean Deliveries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Infertility Consultation &amp; Management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>PCOD/PCOS Treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Menstrual Disorder Treatment</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Fibroid &amp; Ovarian Cyst Management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Antenatal &amp; Postnatal Care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Women’s Preventive Health Checkups</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>NORMAL &amp; CESAREAN DELIVERIES</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>INFERTILITY CONSULTATION</h5>
                                <span>90%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>FAMILY PLANNING &amp; COUNSELING</h5>
                                <span>91%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>WOMEN'S PREVENTIVE HEALTHCARE</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
