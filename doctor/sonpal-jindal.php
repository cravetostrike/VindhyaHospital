...
<head>
    ...
    <title>Dr. Sonpal Jindal - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Sonpal Jindal at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Sonpal Jindal's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-sonpal-jindal.jpg'; ?>" alt="Dr. Sonpal Jindal" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">(MBBS, MS, MCh. - NEUROSURGERY)</span>
                <h1 class="hero-doctor-name">Dr. Sonpal Jindal</h1>
                <p class="hero-subtitle">Neurosurgeon</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MS</span>
                    <span class="degree-pill">MCh (Neurosurgery)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Sonpal Jindal is a highly experienced and skilled Neurosurgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with over 13 years of private practice. He specializes in the diagnosis, surgical treatment, and management of complex neurological conditions, ensuring comprehensive care for both adult and pediatric patients.</p>
                        <p>The Neurosurgery Department at Vindhya Hospital features a well-equipped Advanced Level-II NICU, Neonatal Ventilator (HFO), and Bubble CPAP, supporting critical care for newborns and specialized neurological cases. Dr. Jindal is known for his precision, advanced surgical techniques, and patient-focused approach.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MCh (Neurosurgery):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Neurosurgeon at Vindhya Hospital &amp; Research Centre, Rewa (M.P.).</p>
                        <p>Over 13+ years of dedicated private practice in Neurosurgery, recognized as one of the best Neurosurgeons in Rewa for complex microsurgical, tumor, and pediatric neuro-critical support pathways.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Brain and spinal cord surgeries</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Neuro-trauma and emergency neurosurgical care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pediatric neurosurgery and NICU support</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Treatment of tumors, aneurysms, and vascular malformations</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Minimally invasive and microsurgical procedures</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Pre- and post-operative neurological care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>NEUROSURGERY &amp; COMPLEX NEUROLOGICAL PROCEDURES</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PEDIATRIC &amp; ADULT NEUROLOGICAL CARE</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ADVANCED SURGICAL TECHNIQUES</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT-FOCUSED CRITICAL CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
