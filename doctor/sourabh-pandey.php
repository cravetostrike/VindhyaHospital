...
<head>
    ...
    <title>Dr. Sourabh Pandey - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Sourabh Pandey at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Saurabh Pandey's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-saurabh-pandey.jpg'; ?>" alt="Dr. Saurabh Pandey" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MD – MEDICINE</span>
                <h1 class="hero-doctor-name">Dr. Saurabh Pandey</h1>
                <p class="hero-subtitle">Physician (Internal Medicine Specialist)</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MD (Medicine)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Saurabh Pandey is a dedicated and skilled Physician (MD Medicine) at Vindhya Hospital &amp; Research Centre, Rewa (M.P.), with extensive experience in the field of internal medicine.</p>
                        <p>He specializes in the diagnosis, management, and treatment of a wide range of acute and chronic medical conditions, ensuring holistic care and long-term health improvement for his patients.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MD (Medicine):</strong> [University Name, Year]</p>
                        <p><strong>Residency Training:</strong> Former Resident at Gandhi Medical College, Bhopal.</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        ...
                        <ul>
                            <li>Consultant Physician at Vindhya Hospital &amp; Research Centre, Rewa (M.P.)</li>
                            <li>Presently associated with Sanjay Gandhi Hospital, Rewa</li>
                        </ul>
                        <p><strong>Clinical Strengths:</strong> Extensive background in Internal Medicine managing complex chronic and lifestyle disorders, with early residency foundational training built at Gandhi Medical College, Bhopal.</p>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Diabetes, hypertension &amp; thyroid disorders</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Infectious diseases management</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Chronic respiratory &amp; cardiac diseases</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Lifestyle-related health problems</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Preventive health check-ups &amp; counseling</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Medicine</span>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>INTERNAL MEDICINE &amp; ADULT HEALTHCARE</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>ACUTE ILLNESS &amp; EMERGENCY CARE</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT COUNSELING &amp; PREVENTIVE CARE</h5>
                                <span>97%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value font-small">
                                    Morning – 11:00 AM to 01:00 PM<br>
