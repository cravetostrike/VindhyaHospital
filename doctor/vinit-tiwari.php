...
<head>
    ...
    <title>Dr. vinit tiwari - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. vinit tiwari at Vindhya Hospital &amp; Research Centre, Rewa.">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to Dr. Vinit Kumar Tiwari's image asset -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-vinit-kumar-tiwari.jpg'; ?>" alt="Dr. Vinit Kumar Tiwari" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MS, DrNB, FALS - SURGICAL ONCOLOGY</span>
                <h1 class="hero-doctor-name">Dr. Vinit Kumar Tiwari</h1>
                <p class="hero-subtitle">Cancer Surgeon (Surgical Oncologist)</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MS (Surgery)</span>
                    <span class="degree-pill">DrNB (Surgical Oncology)</span>
                    <span class="degree-pill">FALS</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Vinit Kumar Tiwari is a highly qualified and experienced Cancer Surgeon in Rewa, known for delivering advanced, ethical, and patient-centric cancer care. He offers modern, evidence-based surgical cancer treatments focused on early diagnosis, precision surgery, and faster recovery.</p>
                        <p>Reflecting his strong academic and surgical expertise, his approach blends clinical proficiency with high ethical standards to ensure comprehensive management for solid organ tumors and complex surgical oncological diseases.</p>
                    </div>

                    <!-- Tab 2: Education (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-education">
                        <p><strong>MBBS:</strong> Medical College, Jabalpur</p>
                        <p><strong>MS (Surgery):</strong> Medical College, Jabalpur</p>
                        <p><strong>DrNB Superspeciality (Surgical Oncology):</strong> FIAGES, New Delhi</p>
                        <p><strong>Fellowship:</strong> Fellowship in Robotic and Minimally Invasive Surgery</p>
                        <p><strong>Professional Memberships:</strong> Fellow of the Indian Association of Gastrointestinal Endoscopic Surgeons (FIAGES).</p>
                    </div>

                    <!-- Tab 3: Experience (Hidden by default) -->
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current Practice:</strong> Consultant Cancer Surgeon at Vindhya Hospital &amp; Research Centre, Rewa.</p>
                        <p><strong>Clinical Background:</strong></p>
                        <ul>
                            <li>Extensive specialized experience in Surgical Oncology.</li>
                            <li>DrNB Superspecialist in Cancer Surgery.</li>
                            <li>Advanced training via Fellowship in Robotic &amp; Minimally Invasive Surgery.</li>
                            <li>Widely known for ethical, evidence-based cancer treatment protocols.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="expertise-grid">
                            ...
                            <span>Surgical management of solid organ cancers</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Gastrointestinal (GI) cancers</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Breast cancer surgery</span>
                                                ...
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Head &amp; neck cancer surgery</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Minimally invasive &amp; robotic cancer surgery</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Cancer diagnosis, staging &amp; post-operative care</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Multidisciplinary cancer treatment planning</span>
                        </div>
                                                <div class="expertise-item">
                            <svg viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="expertise-icon"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>
                            <span>Surgical Oncology (Cancer Surgery)</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>SOLID ORGAN CANCER SURGERY</h5>
                                <span>97%</span>
                            </div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>GASTROINTESTINAL (GI) CANCERS</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>HEAD &amp; NECK CANCER SURGERY</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MINIMALLY INVASIVE &amp; ROBOTIC CANCER SURGERY</h5>
                                <span>93%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>CANCER DIAGNOSIS &amp; STAGING</h5>
                                <span>95%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 95%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>MULTIDISCIPLINARY TREATMENT PLANNING</h5>
                                <span>96%</span>
                            </div>
                            <div class="progress-bar-track">
                                <div class="progress-bar-fill" style="width: 96%;"></div>
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>PATIENT ETHICS &amp; EVIDENCE-BASED CARE</h5>
                                <span>98%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value font-small">
                                    Morning: 11:00 AM – 01:00 PM<br>
