...
<head>
    ...
    <title>Dr. Vishal Mishra - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="View details and schedule an appointment with Dr. Vishal Mishra at Vindhya Hospital &amp; Research Centre, Rewa.">
...
<body class="doctor-profile-body">
        ...
        <div class="hero-premium-container">
            ...
            <div class="hero-image-side">
                <div class="neon-image-wrapper">
                    <!-- Pointing to your image asset or a dynamic path -->
                    <img src="<?php echo !empty($doctor['image_path']) ? htmlspecialchars($doctor['image_path']) : 'images/dr-vishal-mishra.jpg'; ?>" alt="Dr. Vishal Mishra" class="hero-doctor-img">
            ...
            <div class="hero-content-side">
                <span class="hero-dept-label">MBBS, MS, MCH. - UROLOGY</span>
                <h1 class="hero-doctor-name">Dr. Vishal Mishra</h1>
                <p class="hero-subtitle">Urologist</p>

                <!-- Degree Pill Blocks -->
                <div class="degree-pill-row">
                    <span class="degree-pill">MBBS</span>
                    <span class="degree-pill">MS (General Surgery)</span>
                    <span class="degree-pill">MCh (Urology)</span>
                </div>
            ...
            <div class="profile-left-column">
                ...
                <div class="profile-card-block tabbed-block">
                    ...
                    <div class="tab-content-body tab-pane active" id="tab-about">
                        <p>Dr. Vishal Mishra is a highly experienced and renowned Urologist practicing at Vindhya Hospital &amp; Research Centre, Rewa (M.P.). With over 15 years of private practice, he has successfully treated children, adults, and families suffering from a wide range of urological conditions.</p>
                        <p>He specializes in the diagnosis and treatment of kidney stones, urinary tract problems, prostate diseases, male infertility, and complex kidney disorders. His patient-centric approach, advanced surgical skills, and compassionate care have earned him recognition as one of the best urologists in Rewa, Satna, Sidhi, Shahdol, and across Madhya Pradesh.</p>
                    </div>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-education">
                        ...
                        <p><strong>MS (General Surgery):</strong> [University Name, Year]</p>
                        <p><strong>MCh (Urology):</strong> [University Name, Year]</p>
                    ...
                    <div class="tab-content-body tab-pane" id="tab-experience">
                        <p><strong>Current:</strong> Consultant Urologist at Vindhya Hospital &amp; Research Centre, Rewa.</p>
                        <p>Over 15+ years of dedicated practice managing complex urological surgeries, pediatric urology, and advanced endoscopic procedures.</p>
                    </div>
                </div>

                <!-- Specializations Block -->
                <div class="profile-card-block">
                    <h2 class="section-title-accent green-line">Specializations</h2>
                ...
                <div class="profile-card-block">
                    ...
                    <div class="skills-wrapper-grid">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>URINARY TRACT INFECTION (UTI) MANAGEMENT</h5>
                                <span>94%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>LAPAROSCOPIC &amp; ENDOSCOPIC SURGERY</h5>
                                <span>90%</span>
                            </div>
                            <div class="progress-bar-track">
                        ...
                        <div class="skill-progress-row">
                            <div class="skill-label-info">
                                <h5>KIDNEY &amp; BLADDER DISORDERS</h5>
                                <span>97%</span>
                            </div>
                            <div class="progress-bar-track">
                    ...
                    <div class="info-list-stack">
                        ...
                        <div class="info-item-row">
                            ...
                            <div class="info-text">
                                ...
                                <p class="value">Afternoon – 12:00 PM to 06:00 PM</p>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // 1. Select all tab buttons and all tab content panes
            ...
            tabButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    // 3. Remove the 'active' class from ALL buttons and ALL panes
                    tabButtons.forEach(btn => btn.classList.remove('active'));
                    tabPanes.forEach(pane => pane.classList.remove('active'));

                    // 4. Add the 'active' class to the specific button that was clicked
                    button.classList.add('active');

                    // 5. Find the corresponding content pane using the data-tab attribute and make it active
