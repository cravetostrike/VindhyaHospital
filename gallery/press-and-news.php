...
<head>
    ...
    <title>press-and-news - Vindhya Hospital &amp; Research Centre</title>
    <meta name="description" content="Latest press releases and news updates from Vindhya Hospital &amp; Research Centre, Rewa.">
...
<body>
    ...
    <main class="main-content" style="padding: 100px 0; min-height: 50vh; display: flex; align-items: center; justify-content: center; background-color: #f8fafc;">
        <div class="container" style="text-align: center;">
            <h1 style="font-family: var(--font-heading); font-size: 2.5rem; font-weight: 800; color: var(--clr-brand); margin-bottom: 15px;">Press & News</h1>
            <p style="font-size: 1.1rem; color: var(--clr-text-muted); max-width: 600px; margin: 0 auto 30px auto;">Latest press releases and news updates from Vindhya Hospital & Research Centre, Rewa.</p>
            <a href="press-and-news/" class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 8px;">
